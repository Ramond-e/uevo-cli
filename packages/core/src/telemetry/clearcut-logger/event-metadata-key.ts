...
export enum EventMetadataKey {
  ...
  UEVO_CLI_USER_PROMPT_LENGTH = 13,
  ...
  // Logs the model id of the API call.
  UEVO_CLI_API_ERROR_MODEL = 30,

  // Logs the error type.
  UEVO_CLI_API_ERROR_TYPE = 31,

  // Logs the status code of the error response.
  UEVO_CLI_API_ERROR_STATUS_CODE = 32,

  // Logs the duration of the API call in milliseconds.
  UEVO_CLI_API_ERROR_DURATION_MS = 33,
  ...
  // Logs the Prompt Id
  UEVO_CLI_PROMPT_ID = 35,

  // Logs the Auth type for the prompt, api responses and errors.
  UEVO_CLI_AUTH_TYPE = 36,

  // Logs the total number of Google accounts ever used.
  UEVO_CLI_GOOGLE_ACCOUNTS_COUNT = 37,

  // Logs the Surface from where the uEVO CLI was invoked, eg: VSCode.
  UEVO_CLI_SURFACE = 39,

  // Logs the session id
  UEVO_CLI_SESSION_ID = 40,
  ...
  UEVO_CLI_LOOP_DETECTED_TYPE = 38,
}
