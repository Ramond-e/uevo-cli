...
export const GEMINI_CONFIG_DIR = '.uevo';
export const DEFAULT_CONTEXT_FILENAME = 'UEVO.md';
export const MEMORY_SECTION_HEADER = '## Gemini Added Memories';

// This variable will hold the currently configured filename for UEVO.md context files.
