    ...
    super(
      ...
      Icon.Folder,
      {
        properties: {
          ...
          file_filtering_options: {
            description:
              'Optional: Whether to respect ignore patterns from .gitignore or .uevoignore',
            type: Type.OBJECT,
            properties: {
              respect_git_ignore: {
                description:
    ...
    try {
      ...
      const fileFilteringOptions = {
        ...
        respectuevoignore:
          ...
          defaultFileIgnores.respectuevoignore,
      };
      ...
      for (const file of files) {
        ...
        if (
          ...
          fileDiscovery.shoulduevoignoreFile(relativePath)
        ) {
          uevoignoredCount++;
          continue;
        }
      ...
      if (uevoignoredCount > 0) {
        ignoredMessages.push(`${uevoignoredCount} gemini-ignored`);
      }
