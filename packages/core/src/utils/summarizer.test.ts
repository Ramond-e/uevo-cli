...
describe('summarizers', () => {
  ...
  beforeEach(() => {
    ...
    (mockAIClient.generateContent as Mock) = vi.fn();
  ...
  describe('summarizeToolOutput', () => {
    ...
    it('should call generateContent if text is longer than maxLength', async () => {
      ...
      (mockAIClient.generateContent as Mock).mockResolvedValue({
    ...
    it('should return original text if generateContent throws an error', async () => {
      ...
      (mockAIClient.generateContent as Mock).mockRejectedValue(error);
    ...
    it('should construct the correct prompt for summarization', async () => {
      ...
      await summarizeToolOutput(longText, mockAIClient, abortSignal, 1000);
...
`;
      const calledWith = (mockAIClient.generateContent as Mock).mock
        .calls[0];
