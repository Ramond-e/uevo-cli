...
const MockedAIClientClass = vi.hoisted(() =>
...
describe('useGeminiStream', () => {
  ...
  beforeEach(() => {
    ...
    // Define the mock for getAIClient
    const mockGetAIClient = vi.fn().mockImplementation(() => {
      // MockedAIClientClass is defined in the module scope by the previous change.
      // It will use the mockStartChat and mockSendMessageStream that are managed within beforeEach.
      const clientInstance = new MockedAIClientClass(mockConfig);
    ...
    // Reset mocks for AIClient instance methods (startChat and sendMessageStream)
    // The AIClient constructor itself is mocked at the module level.
  ...
  const renderTestHook = (
    ...
    const client = geminiClient || mockConfig.getAIClient();
  ...
  it('should submit tool responses when all tool calls are completed and ready', async () => {
    ...
    renderHook(() =>
      useGeminiStream(
        new MockedAIClientClass(mockConfig),
        [],
        mockAddItem,
        mockSetShowHelp,
        mockConfig,
  ...
  it('should handle all tool calls being cancelled', async () => {
    ...
    const client = new MockedAIClientClass(mockConfig);
  ...
  describe('Error Handling', () => {
    it('should call parseAndFormatApiError with the correct authType on stream initialization failure', async () => {
      ...
      const { result } = renderHook(() =>
        useGeminiStream(
          new MockedAIClientClass(testConfig),
          [],
          mockAddItem,
          mockSetShowHelp,
          testConfig,
